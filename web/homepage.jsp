<%-- 
    Document   : homepage
    Created on : Nov 3, 2019, 3:53:27 PM
    Author     : thaoq
--%>
    ...
    <body>
                          ...
                          <div  class="search_input" id="search_input_box">
                                <div class="container ">
                                    ...
                                    <form class="d-flex justify-content-between search-inner col-10">
                                        <input type="text" class="form-control" id="search_input" placeholder="Search Here" en>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-md-6">
                        <h3>Welcome to 
                            Travel Social Network</h3>
                        
                        <div class="add_here">
                            <a href="homepage">
                                
                                
                                <img src="images/2016-06-28-17.15.04-2-1.jpg" alt=""/>
                            </a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6">
                        <div class="add_here">
                            <a href="homepage">
                                ...
                                <img src="images/big-dream-boatman-coron-island-hopping-tour-expedition-3154.jpg.optimal.jpg" alt=""/>
                            </a>
                            <br>
                             <a href="homepage">
                                
                                <img src="images/5d02a993e2dfa.png" alt=""/>
                            </a>
                             <a href="homepage">
                                
                                <img src="images/0a1a-97.jpg" alt=""/>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-10" style="margin-left: 100px;">
            <div  class="comment-form" >
                <h4>Write post</h4>
                <form  class="form-contact comment_form" method="post" action="post" id="commentForm">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">

                                <input class="form-control-file" type="file" name="img" value="Choose an image"/><br>
                                <%for (Toppic t : listToppic) {%>
                                <input type="checkbox" name="topic" value="<%=t.getTid()%>" /><%=t.getName()%> 
                                ...
                                <br>
                                <input class="form-control-label" type="text" name="title" value="" placeholder="Title"/>
                        ...
                        <div class="form-group">
                            <button name="submit" type="submit" class="button button-contactForm btn_1 boxed-btn">Post</button>
                        </div>
                </form>
            </div>
        </div>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="blog_right_side">
                        ...
                        <div class="add_here text-center">
                            <a href="#">
                                <img src="images/img/most_recent/googleAdd.jpg" alt="">
                            </a>
                        </div>
                        <div class="section_title mb-33">
                            <h3>Tags</h3>
